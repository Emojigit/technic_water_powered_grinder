...
minetest.register_craft({
	output = 'technic_water_powered_grinder:water_powered_grinder',
	recipe = {
...
local function run_water_grinder(pos, elapsed)
	...
	if powered then 
		...
		if result then
			...
			if meta:get_int("processing") == 5 then
				...
				if not recipe then
					...
					technic.swap_node(pos, "technic_water_powered_grinder:water_powered_grinder")
				...
				meta:set_string("infotext", S("%s is active"):format(machine_name).." ("..percent.."%)")
				technic.swap_node(pos, "technic_water_powered_grinder:water_powered_grinder_active")
				meta:set_string("formspec",
								"size[8,9]"..
									"label[0,0;"..machine_name.."]"..
									"image[2,2;1,1;technic_power_meter_bg.png^[lowpart:" .. percent .. ":technic_power_meter_fg.png]"..
		...
		technic.swap_node(pos, "technic_water_powered_grinder:water_powered_grinder_unpowered")
		meta:set_string("formspec", formspec)
	end
	return true
...
minetest.register_node("technic_water_powered_grinder:water_powered_grinder", {
...
minetest.register_node("technic_water_powered_grinder:water_powered_grinder_unpowered", {
	description = machine_name,
	tiles = {"technic_water_powered_grinder_top.png",  "technic_water_powered_grinder_side.png",
	         "technic_water_powered_grinder_side.png", "technic_water_powered_grinder_side.png",
	         "technic_water_powered_grinder_side.png", "technic_water_powered_grinder_front_unpowered.png"},
	paramtype2 = "facedir",
	drop = "technic_water_powered_grinder:water_powered_grinder",
...
minetest.register_node("technic_water_powered_grinder:water_powered_grinder_active", {
	description = machine_name,
	tiles = {"technic_water_powered_grinder_top.png",  "technic_water_powered_grinder_side.png",
	         "technic_water_powered_grinder_side.png", "technic_water_powered_grinder_side.png",
